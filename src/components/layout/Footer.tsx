...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full border-t border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-950 mt-12">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <p className="text-center text-sm text-slate-500 dark:text-slate-400 sm:text-left font-medium">
            © {new Date().getFullYear()} CollegeCompass. Developed for AI Software Engineer Internship.
          </p>
